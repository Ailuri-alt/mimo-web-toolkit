...
Следовать поэтапному плану в `docs/ROADMAP.md` (20 этапов). Каждый этап завершается полностью рабочим состоянием. Никогда не пропускать этапы. Перед каждым этапом: объяснить архитектуру, показать дерево файлов, затем писать полный код.
...
| ROADMAP.md | План из 20 этапов, соблюдать порядок |
